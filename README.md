...
Automation that watches upstream releases for the package recipes in [yacp-dev/ports](https://github.com/yacp-dev/ports), and drives the whole loop of updating the `cygport` file, building the package, and opening a PR against yacp.
